...
// The menu that shows up when the game is paused
public class PauseMenu extends Menu {
	
	private final String[] options = { "Resume", "Quit" };
	...
	public void render(Bitmap bitmap) {
		...
		bitmap.draw("Paused", (bitmap.width - ("Paused").length() * Assets.FONT_STRIDE_X) / 2, (int) (h12 * 3.5), 0xFFFF00);
